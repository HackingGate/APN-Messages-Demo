...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GHBigNum/GHBigNum.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KBKeybase/KBKeybase.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KBPGP/KBPGP.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TSTripleSec/TSTripleSec.framework"
